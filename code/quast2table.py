...
'''
Modified from https://github.com/npbhavya/Metagenome-assembled-genomes-workflow/blob/master/scripts/quast_table.py

This script takes the quast output from multiple files - and generates one big table from quast output - report.tsv 
To run this code 
